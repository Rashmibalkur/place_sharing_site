...
class SharesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post shares_url, params: { share: { name: @share.name, place_id: @share.place_id, user_id: @share.user_id } }
    end
  ...
  test "should update share" do
    patch share_url(@share), params: { share: { name: @share.name, place_id: @share.place_id, user_id: @share.user_id } }
